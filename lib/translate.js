// Translate TokenRhythm SSE payloads into harness StreamChunks: one stateful
// block per content/reasoning/tool-call index; finish + usage deferred to
// [DONE] so no chunk ever follows `finish`.
// @module dsh-opensquilla/translate
